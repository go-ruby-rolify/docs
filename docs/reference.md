...
The public API lives at the module root (`github.com/go-ruby-rolify/rolify`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rolify`, while the surface follows
...
```go
import "github.com/go-ruby-rolify/rolify"
```
...
- **[pkg.go.dev/github.com/go-ruby-rolify/rolify](https://pkg.go.dev/github.com/go-ruby-rolify/rolify)**

The module's [README](https://github.com/go-ruby-rolify/rolify#readme) carries worked
