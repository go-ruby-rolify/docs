# go-ruby-rolify documentation

**Pure-Go Rolify: role management/authorization (global/class/instance scopes), CGO=0 — bound into rbgo**

`go-ruby-rolify/rolify` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `rolify`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `rolify`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`rolify`](https://github.com/go-ruby-rolify/rolify) | the library — Ruby's `rolify` in pure Go |
| [`docs`](https://github.com/go-ruby-rolify/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-rolify.github.io`](https://github.com/go-ruby-rolify/go-ruby-rolify.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-rolify/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-rolify/rolify](https://github.com/go-ruby-rolify/rolify).
