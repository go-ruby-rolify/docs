...
Contributions are welcome. `go-ruby-rolify/rolify` is built to a small set of
...
The library is in [`github.com/go-ruby-rolify/rolify`](https://github.com/go-ruby-rolify/rolify).
This documentation site is in [`github.com/go-ruby-rolify/docs`](https://github.com/go-ruby-rolify/docs).
